      ...
      <div className="text-center">
        ...
        <div className="flex justify-center mb-6">
          <div className="relative w-16 h-16">
            ...
            <div className="relative w-16 h-16 bg-gradient-to-br from-primary/10 to-primary/20 rounded-full flex items-center justify-center shadow-lg">
        ...
        <p className="text-text-tertiary text-sm mt-1">请稍候</p>
    ...
    <div className={`bg-white/90 backdrop-blur rounded-3xl shadow-lg border border-sumi-100 p-6 ${className}`}>
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div className="flex-1 space-y-2">
          <div className="h-5 bg-neutral-100 rounded-lg w-1/3 animate-pulse" />
          <div className="h-4 bg-neutral-50 rounded-lg w-2/3 animate-pulse" />
        </div>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="h-4 bg-neutral-50 rounded-lg w-4/6 animate-pulse" />
      </div>

      {/* Action skeleton */}
      <div className="mt-6 flex gap-3">
        <div className="h-12 bg-neutral-100 rounded-2xl flex-1 animate-pulse" />
        <div className="h-12 bg-neutral-100 rounded-2xl flex-1 animate-pulse" />
      </div>
    </div>
  );
